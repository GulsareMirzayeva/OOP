...
function yashUser() {
    ...
    if (userInput === "") {
        alert("Bu xana boş buraxıla bilməz.");
    } else {
        let age = parseInt(userInput);

        if (isNaN(age)) {
            alert("Xahiş olunur düzgün dəyər daxil edəsiniz");
        } else if (age < 18) {
            alert(`Yaşınız ${age}, ${18 - age} ilden sonra sifariş tamamlana bilər.`);
        } else {
